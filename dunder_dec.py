...
def _mapper(this, func, var_name, *others):
    ...
    function = getattr(getattr(this, var_name), func)
...
def _make_func(this, func:str, var_name:str, wrapper, *others) -> "function": #__add__, num
    function = getattr(getattr(this, var_name), func)
...
class add_methods(object):
    def __init__(self, var_name:str, *funcs:str, wrapper = lambda value: value):
        self.var_name = var_name #Can be string or function
        self.funcs = funcs
    ...
    def __call__(self, cls):
        class Decorated(cls):
            for func in self.funcs:
                setattr(cls, func, lambda this, *others, func = func: _make_func(this, func, self.var_name, self.wrapper, *others))
...
if __name__ == "__main__":
    @add_methods("num", "__add__", "__mul__", wrapper = float) #"__add__" -> def __add__(self, other): return self.num + other.num
